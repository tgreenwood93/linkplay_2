...
void send_linkplay_pic_volume()
{
    ...
    {   
        case(e_OUTPUT_TYPE_Headphones):
            ...
            Linkplay_Printf(CS_GetHeadphoneVolume());
            break;    
        case(e_OUTPUT_TYPE_Main):
            Serial1.print("MCU+VOL+");
            Linkplay_Printf(CS_GetVolume());
            break;
        default:
            break;
    }
...
void dump_stored_linkplay_data()
{
    ...
    Debug_Printf("linkplay in reset?: %d\n", LP_Get_linkplay_in_reset());
    Debug_Printf("internet status: %d\n", (uint8_t)LP_Get_linkplay_internet_status());
    ...
    Debug_Printf("repeat/shuffle status: %s\n", LP_Get_linkplay_repeat_shuffle());
    ...
    Debug_Printf("playback status: %s\n", LP_Get_linkplay_playback_status());
    Debug_Printf("mute status: %s\n", LP_Get_linkplay_mute());
    Debug_Printf("factory init status: %s\n", LP_Get_linkplay_factory_status());
    Debug_Printf("ssid: %s\n", LP_Get_linkplay_ssid());
    Debug_Printf("language: %s\n", LP_Get_linkplay_language());
    ...
    Debug_Printf("version update?: %s\n", LP_Get_linkplay_version_update());
    Debug_Printf("new linkplay version: %s\n", LP_Get_linkplay_new_version());
    ...
    Debug_Printf("firmware update hidden: %s\n", LP_Get_linkplay_firmware_update_hidden());
    Debug_Printf("web login result: %s\n", LP_Get_linkplay_web_login_result());
    Debug_Printf("ignore talk start: %s\n", LP_Get_linkplay_ignore_talk_start());
    Debug_Printf("silence ota time: %s\n", LP_Get_linkplay_silence_OTA_time());
    Debug_Printf("iHeartRadio new: %s\n", LP_Get_linkplay_iHeartRadio_new());
    Debug_Printf("privacy mode: %s\n", LP_Get_linkplay_privacy_mode());
...
{
    Linkplay_Printf(mcu_commands[31]);
}
